...
// - 컴파일 에러: 소스 코드의 문법을 준수하지 않았을 떄 발생
// 1. 문법 오류: 괄호, 세미콜론 등의 잘못된 사용
// 2. 타입 불일치: 변수의 타입이나 메서드의 반환 타입이 일치하지 않을 떄
// 3. 미선언 변쉬 선언되지 않은 변수 혹은 메서드를 사용할 때(오타)
...
// 예외: 프로그램 정상 실행 중 발생할 수 있는 예상치 못한 상황
