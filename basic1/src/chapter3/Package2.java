...
//		list.add("99");
		...
		// 변수로 반환값을 받을 땐 null이 올 수 있음을 주의
		...
		// add() : 요소를 추가함 만약 동일한 요소가 존재한다면 추가하지 않음
		set.add("apple");
		...
		// containts() : Set에 특정 요소가 존재하는지 확인
		...
		// get() : Map에서 특정 키를 가지는 요소를 반환 (ex - "Apple"을 키로 갖는 "사과" 반환)
		// 존재하지 않는 키를 검색하면 null 반환
