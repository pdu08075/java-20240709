...
public class Package3 {
	...
	public static void main(String[] args) {
		...
		// Date 클래스의 대부분의 메서드는 Java 1.1 부터 사용
		Date dateNow = new Date();
		System.out.println(dateNow);
		System.out.println(dateNow.getDate());
		
		// LocalDateTime 클래스: Java 8 부터 Date를 대체하기 위해 사용
		// LocalDateTime 클래스, LocalTime 클래스, LocalDateTime 클래스
		...
		// Date 인스턴스의 toInstante(), toLocalDateTime()
