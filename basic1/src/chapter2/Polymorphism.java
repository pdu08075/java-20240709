...
// 다운캐스팅: '업캐스팅'된 객페를 다시 우너래 타입의 변수에 담을 수 있도록 하는 것
...
//		System.out.println(human2.team);		// error(확인 불가)
//		human2.kick();		// error(확인 불가)
		
		FootballPlay footballPlay = footballPlayer;
		footballPlay.kick();
		footballPlay.foul();
		
//		System.out.println(footballPlay.name);		// error(확인 불가)
//		System.out.println(footballPlay.age);		// error(확인 불가)
