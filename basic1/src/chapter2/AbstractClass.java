...
// 추상 클래스 자체로 인스턴스를 생성할 수 없음, 반드시 추상 클래스를 확장한 하위 클래스로 인스턴스를 생성해야 함
// abstract class 추상클래스명 {}

// 추상 메서드: 선언부만 존재하고 구현부는 존재하지 않는 메서드
// 추상 클래스 내부 혹은 인터페이스에서만 선언할 수 있음
...
class Developer2 extends Human2 {
	...
	@Override
	void greet() {
		System.out.println("저는 " + name + "이고 " + age + "세이면서 개발자입니다.");
	}
...
class Police2 extends Human2 {
	...
	@Override
	void greet() {
		System.out.println("저는 " + name + "이고 " + age + "세이면서 경찰입니다.");
	}
