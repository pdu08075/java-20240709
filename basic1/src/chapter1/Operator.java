...
public class Operator {
	...
	public static void main(String[] args) {
		...
		// 일반 대입 연산자: =
		// 좌항에 우항의 연산 결과 할당
		// 좌항이 일반 변수와 상수형 변수 모두 
		// 단, 상수형 변수는 초기화 시에만 사용 가능
		number = 10 + 5;
		
		// 복합 대입 연산자: 타연산자=
		// 좌항에 좌항과 우항을 연산한 결과를 할당
		// 좌항은 반드시 초기화가 되어 있어야 함
		// 좌항은 반드시 일반 변수와 와야 함(상수 불가능)
		number += 3;
		System.out.println(number);
		number /= 7;
		System.out.println(number);
		...
		// 크다, 크거나 같다 연산
		// > : 좌항이 우항보다 크면 true, 작서나 같으면 false
		...
		// 논리 연산자ㅣ 피연산자가 모두 논리형태, 피연자를 조합함
		// 논리 AND 연산자: && 좌항과 우항이 모두 true이면 atrue, 하나라도 false이면 false
