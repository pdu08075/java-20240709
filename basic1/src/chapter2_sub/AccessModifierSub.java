...
// chapter2 package에 선언된 Accessodifier 클래스는
// 접근 제어자가 public이기 때문에 외부 패키징서 import가 가능
import chapter2.AccessModifier;

// chapter2 package에 선언된 AccessModifierRun 클래스는
// 접근 제어자가 deafult(package)ㅇ기 때문에 외부 패키지에서 ipmort가 분가능
...
public class AccessModifierSub {
	...
	void method() {
		...
		// 접근제어자가 public 이기 때문에 외부 패키지에서접근이 가능
...
//		instance.privateVariable = 0;
		...
		// AccessModifier의 publicVVariable, protectedVariable 필드는
		// 접근 제어자가 각각 public, protected이기 때문에 자손 클래스에서 접근이 가능
		super.publicVariable = 0;
		super.protectedVariable = 0;
		
		// AccessModifier의 defaultVariable, privateVariable, privateVariable 필드는
